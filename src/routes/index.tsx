  ...
  head: () => ({
    meta: [
      ...
      },
      {
        ...
        content:
          "Реклама, аналитика, контент и дизайн — одна команда вместо пяти сотрудников.",
      },
    ],
  }),
  component: HomePage,
...
function HomePage() {
  ...
  const principles = [
    ...
    {
      no: "03",
      title: "Команда, а не сотрудник",
      body:
        "Персональный менеджер, стратег, digital-специалист, аналитик и видеограф закреплены за вашим проектом. Без перекидывания задач.",
    },
  ];
          ...
          <div className="mt-10 grid items-center gap-12 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
            ...
            <div>
              ...
              <p className="mt-8 max-w-xl text-lg text-muted-foreground md:text-xl">
                ...
                сквозная аналитика и оригинальный контент — одна команда вместо пяти сотрудников.
              </p>
