...
const PHASES = [
  ...
  { step: "06", title: "Документация", desc: "Финальное ТЗ в формате PDF, готовое к передаче разработчикам или тендеру." },
];
...
const FOR_WHOM = [
  ...
  { t: "Корпорации", d: "Документ для тендера и контроля разработчиков." },
  { t: "Продуктовые команды", d: "Системное планирование сложного релиза или нового модуля." },
];

const FAQ = [
  { q: "Подойдёт ТЗ для тендера?", a: "Да, документ содержит функциональные и нефункциональные требования, по которым разработчики могут адекватно оценить проект." },
