  ...
  head: () => ({
    meta: [
      { title: "Комплексный маркетинг под ключ — отдел маркетинга на аутсорсе | ABP DIGITAL" },
      {
        name: "description",
        content:
          "Полноценный отдел маркетинга на аутсорсе: стратег, digital-маркетолог, аналитик, дизайнер. Все каналы, аналитика и креативы.",
      },
      { property: "og:title", content: "Комплексный маркетинг под ключ — ABP DIGITAL" },
      {
        property: "og:description",
        content: "Один контракт вместо пяти сотрудников. Стратегия, реклама, аналитика, креативы.",
      },
    ],
  }),
...
const PROBLEMS = [
  { p: "5 сотрудников, никто не отвечает за итог", s: "Один контракт, один P&L, один менеджер" },
          ...
          <div className="mt-10 grid gap-12 lg:grid-cols-[1.5fr_1fr] lg:gap-16">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
                ...
                как штатная команда. Без найма, HR и срывов сроков.
              </p>
