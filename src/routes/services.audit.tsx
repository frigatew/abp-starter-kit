...
const FAQ = [
  ...
  { q: "Можно ли потом не работать с вами?", a: "Да, аудит — самостоятельный продукт. PDF и backlog ваши, можете внедрять сами или с другим разработчиками. Никаких обязательств." },
