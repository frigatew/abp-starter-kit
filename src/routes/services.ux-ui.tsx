...
const NOT_FOR = [
  { p: "Промо-лендинг", n: "Для этого у нас есть отдельная услуга." },
  { p: "«Перерисовать сайт красиво»", n: "Без UX-исследования это просто косметика — мы так не работаем." },
  { p: "Дизайн за 3 дня", n: "Качественный продуктовый дизайн нельзя сделать за неделю. Минимум — 2–6 недель." },
];
...
const FAQ = [
  ...
  { q: "Работаете ли с лендингами?", a: "Да, Мы полноценно разработаем для вас лендинг. В рамках услуги по разработке сайтов." },
